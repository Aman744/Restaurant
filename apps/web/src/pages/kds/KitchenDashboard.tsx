...
import { ChefHat, Flame, CheckCircle, Clock, Bell, Settings, Search, AlertCircle } from 'lucide-react';
        ...
        {currentView === 'inventory' ? (
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between border-b border-zinc-900 pb-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs text-zinc-500 font-medium">
                  Queue: {kdsOrders.length} active tickets
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {kdsOrders.length === 0 && (
                <div className="col-span-full border border-dashed border-zinc-850 py-20 text-center text-zinc-500 rounded-3xl">
                  ...
                  <p className="text-xs text-zinc-550 mt-1">No orders pending in this kitchen queue</p>
                </div>
              )}
            </div>
          </div>
